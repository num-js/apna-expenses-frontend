...
const AddExpenseForm = ({ setToggleBottomSheet }) => {
        ...
        <div class="flex">
            <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-4 flex flex-col md:ml-auto w-full z-10 shadow-md">
                <form onSubmit={addExpenseHandler}>
                    <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">Add Expenses</h2>
                    <div class="mb-4">
                        <label for="expense" class="leading-7 text-sm text-gray-600">Expense</label>
                        <input type="text" id="expense" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                            value={expense}
